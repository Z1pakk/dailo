...
// using Dailo.Api.DTOs.Habits;
// using Dailo.Api.Entities;
// using Dailo.Api.Services;
// using Dailo.Api.Services.Sorting;
...
//             .Habits.Where(h => h.Id == id && h.UserId == userId)
...
//         }
//
//         Habit? habit = await dbContext.Habits.FirstOrDefaultAsync(h =>
